...
const MEMORY_DATA: MemorySection[] = [
  {
    title: "Long-term Memory (LTM)",
    data: [
      { id: "l1", title: "States", type: "parent" },
      { id: "l2", title: "Products Catalog", type: "child" },
      { id: "l3", title: "Instances", type: "parent" },
  ...
  },
  {
    ...
    data: [
      ...
      {
        id: "s_or_6",
        title: "🚕 Transport / Booking / Rental",
        type: "parent",
      },
          ...
          >
            <Text
              style={[
                styles.itemTitle,
                item.type === "child"
                  ? [styles.childText, { color: colors.secondaryText }]
                  : [styles.parentText, { color: colors.text }],
              ]}
            >
              {item.title}
            </Text>
