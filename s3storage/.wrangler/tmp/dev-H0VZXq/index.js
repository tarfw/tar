...
// .wrangler/tmp/bundle-xLXkbQ/checked-fetch.js
...
// .wrangler/tmp/bundle-xLXkbQ/strip-cf-connecting-ip-header.js
      ...
      try {
        ...
        if (filename !== "user.db") {
          const signedDownloadRequest = await aws.sign(new Request(s3Url, {
            method: "GET"
          }), { aws: { signQuery: true }, expires: 7776e3 });
...
// .wrangler/tmp/bundle-xLXkbQ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-xLXkbQ/middleware-loader.entry.ts
