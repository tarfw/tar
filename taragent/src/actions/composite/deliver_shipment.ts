...
/**
 * Mark a shipment as delivered and notify.
 * @param input - Delivery details
 * @param input.shipmentId - Shipment matter ID
 * @param input.scope - Tenant scope
 * @returns Whether shipment was delivered
 */
export async function actionDeliverShipment(input: {
  shipmentId: string;
  scope: string;
