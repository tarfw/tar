...
export default function EntityScreen() {
  ...
  const motionLabel = (action: number) => {
    const labels: Record<number, string> = {
      100: 'Subtask added', 207: 'Due soon', 208: 'Overdue',
      301: 'Store visit', 302: 'Review', 303: 'Created',
      306: 'Ticket opened', 307: 'Reply',
      401: 'Dispatched', 402: 'In transit', 407: 'Return', 410: 'Delivered',
      501: 'Clock in', 502: 'Clock out', 505: 'Performance note', 506: 'Leave request',
          ...
          <View style={styles.chipsRow}>
            ...
            {data.role ? (
              <View style={[styles.chip, { backgroundColor: theme.backgroundElement }]}>
                ...
                <Text style={[styles.chipText, { color: theme.textSecondary }]}>{data.role}</Text>
              </View>
            ) : null}
          </View>
        )}
