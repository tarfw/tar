...
export default function CreateFormScreen() {
  ...
  const FORM_OPCODES: any[] = [
    { code: 601, label: "PUSH SENT", defaultStatus: "SENT", hasDelta: false, defaultData: { campaign: "summer_sale" }, color: "#3b82f6" },
    { code: 602, label: "SMS SENT", defaultStatus: "SENT", hasDelta: false, defaultData: { tracking_id: "sms_9821" }, color: "#8b5cf6" },
    { code: 603, label: "REFERRAL", defaultStatus: "REDEEMED", hasDelta: false, defaultData: { referrer_id: "user_abc" }, color: "#f59e0b" },
    { code: 604, label: "FORM SUBMIT", defaultStatus: "SUBMITTED", hasDelta: false, defaultData: { fields_filled: 5 }, color: "#10b981" },
  ];
          ...
          <View style={styles.cardHeaderRow}>
            <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
              <View style={styles.sentenceTypeBadge}>
                <Text style={styles.sentenceTypeBadgeText}>FORM</Text>
              </View>
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  formFieldsList: { gap: 8, marginTop: 8 },
  formPreviewField: { flexDirection: "row", alignItems: "center", borderBottomWidth: 0.5, borderBottomColor: "#f4f4f5", paddingVertical: 8 },
  formPreviewFieldLabel: { width: 100, fontSize: 14, fontWeight: "600", color: "#71717a" },
  formPreviewInputPlaceholder: { flex: 1, height: 32, backgroundColor: "#fafafa", borderRadius: 6, borderStyle: "dashed", borderWidth: 1, borderColor: "#e4e4e7" },
  formCardHelp: { fontSize: 13, color: "#a1a1aa", fontStyle: "italic", marginTop: 8 },
  opcodeSection: {
    marginTop: 24,
    borderTopWidth: 1,
