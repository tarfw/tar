...
export default function CreateProfileScreen() {
  ...
  const PROFILE_OPCODES: any[] = [
    { code: 301, label: "STORE VISIT", defaultStatus: "VISITED", hasDelta: false, defaultData: { store_id: "main_branch" }, color: "#3b82f6" },
    { code: 303, label: "LEAD CREATED", defaultStatus: "NEW_LEAD", hasDelta: false, defaultData: { source: "web_referral" }, color: "#f59e0b" },
    { code: 304, label: "CONTACTED", defaultStatus: "CONTACTED", hasDelta: false, defaultData: { channel: "email" }, color: "#8b5cf6" },
    { code: 305, label: "CONVERTED", defaultStatus: "CONVERTED", hasDelta: false, defaultData: { plan: "pro" }, color: "#10b981" },
    { code: 501, label: "CLOCK IN", defaultStatus: "CLOCKED_IN", hasDelta: false, defaultData: { location: "front_desk" }, color: "#06b6d4" },
    { code: 502, label: "CLOCK OUT", defaultStatus: "CLOCKED_OUT", hasDelta: false, defaultData: { duration_hours: 8 }, color: "#6b7280" },
    { code: 506, label: "LEAVE REQUESTED", defaultStatus: "REQUESTED", hasDelta: false, defaultData: { leave_type: "sick" }, color: "#ef4444" },
    { code: 901, label: "BOOKING", defaultStatus: "BOOKED", hasDelta: false, defaultData: { resource: "vehicle_4" }, color: "#ec4899" },
    { code: 906, label: "RECRUIT APPLY", defaultStatus: "APPLIED", hasDelta: false, defaultData: { position: "react_developer" }, color: "#10b981" },
  ];
  ...
  const executeOpcodeAction = async (opcodeOpt: any) => {
    ...
    if (!finalTitle) {
      Alert.alert("Validation Error", "Please enter a name first.");
      return;
    }
  ...
  useEffect(() => {
    async function initFields() {
      ...
      setMatterId(`profile_${randSuffix}`);
    }
    initFields();
  }, []);
          ...
          <View style={styles.cardHeaderRow}>
            <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
              <View style={styles.sentenceTypeBadge}>
                <Text style={styles.sentenceTypeBadgeText}>PROFILE</Text>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  avatarCircleSmall: { width: 28, height: 28, borderRadius: 14, backgroundColor: "#f4f4f5", borderWidth: 1, borderColor: "#e4e4e7", justifyContent: "center", alignItems: "center" },
  avatarInitialSmall: { fontSize: 12, fontWeight: "700", color: "#3f3f46" },
  ...
  storefrontDetailsSection: { gap: 8, marginTop: 6 },
  storefrontDetailsRow: { flexDirection: "row", alignItems: "center", gap: 8 },
  storefrontDetailsLabel: { fontSize: 13, fontWeight: "600", color: "#71717a", width: 70 },
  opcodeSection: {
    marginTop: 24,
    borderTopWidth: 1,
