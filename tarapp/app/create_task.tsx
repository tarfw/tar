...
export default function CreateTaskScreen() {
  ...
  const TASK_OPCODES: any[] = [
    { code: 306, label: "TICKET OPEN", defaultStatus: "OPEN", hasDelta: false, defaultData: { urgency: "medium" }, color: "#3b82f6" },
    { code: 308, label: "RESOLVED", defaultStatus: "RESOLVED", hasDelta: false, defaultData: { resolution: "fixed_bug" }, color: "#10b981" },
    { code: 504, label: "TASK ASSIGNED", defaultStatus: "ASSIGNED", hasDelta: false, defaultData: { assignee: "staff_member" }, color: "#8b5cf6" },
    { code: 701, label: "BOOKED", defaultStatus: "BOOKED", hasDelta: false, defaultData: { time_slot: "14:00" }, color: "#f59e0b" },
    { code: 702, label: "COMPLETED", defaultStatus: "COMPLETED", hasDelta: false, defaultData: { notes: "service_concluded" }, color: "#10b981" },
    { code: 703, label: "CANCELLED", defaultStatus: "CANCELLED", hasDelta: false, defaultData: { reason: "no_show" }, color: "#ef4444" },
  ];
          ...
          <View style={styles.cardHeaderRow}>
            <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
              <View style={styles.sentenceTypeBadge}>
                <Text style={styles.sentenceTypeBadgeText}>TASK</Text>
              </View>
            </View>
